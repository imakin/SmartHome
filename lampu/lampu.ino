...
//~ #define SET_DATE_TIME_JUST_ONCE
    ...
    dayofmonth = 10; // Day of month, 1...31
    month      = 12;  // month 1...12
    year       = 2017;
...
void loop()
{
    ...
    if (bcd2bin( rtc.h24.Hour10, rtc.h24.Hour)>=17) {
        if (lamp_set==false) {
            lampu_turn(true);
            Serial.print("lampu aktifkan\n");
            lamp_set = true;
            lamp_clear = false;
        }
        else {
            Serial.print("lampu sudah diaktifkan, skip\n");
        }
    }
    else if (bcd2bin( rtc.h24.Hour10, rtc.h24.Hour)>=5) {
        if (lamp_clear==false) {
            lampu_turn(false);
            Serial.print("lampu matikan\n");
            lamp_clear = true;
            lamp_set = false;
        }
        else {
            Serial.print("lampu sudah dimatikan, skip\n");
        }
    }
...
void lampu_turn(bool on) {
    uint8_t pin_relay = 12;
    uint8_t pin_relay_2 = 11;
